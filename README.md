...
```run_models.py --config view_3dgs.txt``` - This views a 3DGS model that has been trained on one of our plants

```run_models.py --config train_3dgs.txt``` - This trains a new 3DGS model of one of our plants

```run_models.py --config view_nerf.txt``` - This views a nerf model that has been trained on one of our plants

```run_models.py --config train_nerf.txt``` - This trains a new nerf model of one of our plants
